  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (result.success) {
      toast.success(t("auth.signUpSuccess") || "Account created successfully!", {
        description: t("auth.signUpSuccessDesc") || "Welcome to Bedir Group! Redirecting...",
        duration: 3000,
      });
      navigate("/", { replace: true });
    } else {
      const errorMsg = result.error || t("auth.registrationFailed");
      setError(errorMsg);
      toast.error(t("auth.signUpFailed") || "Registration failed", {
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <div className="relative">
                <User className="absolute left-4 top-1/2 -translate-y-1/2 h-4 w-4 text-charcoal-light" />
                <input
                  type="text"
                  value={name}
